...
DATA_ROOT = os.path.join(PROJECT_ROOT, 'data', 'brain_tumor')
...
metainfo = dict(classes=('brain-tumor', 'label0', 'label1', 'label2'))
...
dataset = dict(
    ...
    metainfo=metainfo,
    data_root=DATA_ROOT,
    ann_file='test/_annotations.cleaned.coco.json',
...
val_evaluator = dict(
    _delete_=True,
    type='CocoMetric',
    ann_file=os.path.join(DATA_ROOT, 'test/_annotations.cleaned.coco.json'),
    metric='bbox',
    classwise=True,
